...
from anomaly_detectors.earthgeckoSkyline.algorithms import (
    histogram_bins, first_hour_average, stddev_from_average, mean_subtraction_cumulation,
    median_absolute_deviation, stddev_from_moving_average, least_squares)
...
if GRUBBS_KS_TEST_ENABLED:
    ...
    try:
        ...
        sys.exit(1)
    from OnlineDetectors.earthgeckoSkyline.skyline_algorithms import grubbs, ks_test


class EarthgeckoSkylineDetector(OnlineAnomalyDetector):
    """
