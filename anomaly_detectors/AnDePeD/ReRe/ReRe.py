...
class ReRe:
    ...
    def __init__(self):
        from anomaly_detectors.AnDePeD.ReRe.lstm_func import Lstm
    ...
    from anomaly_detectors.AnDePeD.ReRe.initial import param_refresh, load, initialize_cons
    from anomaly_detectors.AnDePeD.ReRe.main_algo import initialize_rere, set_values, next_timestep, get_latest_anomaly
    from anomaly_detectors.AnDePeD.ReRe.offset_comp import init_offset_compensation, compensate_offset
    from anomaly_detectors.AnDePeD.ReRe.auto_offset_comp import init_auto_offset_compensation, auto_tune_offset
    from anomaly_detectors.AnDePeD.ReRe.timer import init_timer, start_timestep, end_timestep
    from anomaly_detectors.AnDePeD.ReRe.preprocess import preprocess
    from anomaly_detectors.AnDePeD.ReRe.auto_ws_ap import init_auto_ws_ap, auto_tune_ws_ap
    from anomaly_detectors.AnDePeD.ReRe.to_csv import init_to_csv, dump_hyperparameters, dump_results, write_time
    from anomaly_detectors.AnDePeD.ReRe.window_ageing import update_window_beginning, ageing_coefficient
    from anomaly_detectors.AnDePeD.ReRe.thd_aare_func import aare, thd_1, thd_2
