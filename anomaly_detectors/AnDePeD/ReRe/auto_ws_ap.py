...
import anomaly_detectors.AnDePeD.ReRe.auto_ws_ap_criteria as criteria
import numpy as np
...
def auto_tune_ws_ap(self, time):
   # automatic WINDOW_SIZE and AGE_POWER component
    if self.USE_AUTOMATIC_WS_AP:
        # if the last adjustment happened more than B timesteps ago (and we are past the initial timesteps)
