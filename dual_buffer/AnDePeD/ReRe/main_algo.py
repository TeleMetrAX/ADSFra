"""
MAIN ALGORITHM OF ANDEPED

This file contains the initialization and operation of the AnDePeD algorithm and its improvements.
"""

import numpy as np
import dual_buffer.AnDePeD.ReRe.status_bar as bar
...
def next_timestep(self, time):
    if self.STATUS_BAR and not self.DEBUG:
        ...
        if self.DEBUG:
            print('AnDePeD\'s begun timestep {}/{}'.format(time, self.length - 1))
