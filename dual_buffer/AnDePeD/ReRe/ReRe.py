...
class ReRe:
    ...
    def __init__(self):
        from dual_buffer.AnDePeD.ReRe.lstm_func import Lstm
    ...
    from dual_buffer.AnDePeD.ReRe.initial import param_refresh, load, initialize_cons
    from dual_buffer.AnDePeD.ReRe.main_algo import initialize_rere, next_timestep
    from dual_buffer.AnDePeD.ReRe.offset_comp import init_offset_compensation, compensate_offset
    from dual_buffer.AnDePeD.ReRe.auto_offset_comp import init_auto_offset_compensation, auto_tune_offset
    from dual_buffer.AnDePeD.ReRe.timer import init_timer, start_timestep, end_timestep
    from dual_buffer.AnDePeD.ReRe.preprocess import preprocess
    from dual_buffer.AnDePeD.ReRe.auto_ws_ap import init_auto_ws_ap, auto_tune_ws_ap
    from dual_buffer.AnDePeD.ReRe.to_csv import init_to_csv, dump_hyperparameters, dump_results, write_time
    from dual_buffer.AnDePeD.ReRe.window_ageing import update_window_beginning, ageing_coefficient
    from dual_buffer.AnDePeD.ReRe.thd_aare_func import aare, thd_1, thd_2
